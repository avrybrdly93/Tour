$(document).ready(function() {
    ...
    function searchUserChoice(userSelect) {

        let urlVariable = "http://api.eventful.com/json/events/search?location="+ userCity + "&keywords=" + userSelect + "&app_key=SGgPCPhjx34hgXV2";
    ...
    $(".user-button").on("click", function() {
        ...
        console.log(userButtonInput);
        DOMStuff();
        searchUserChoice(userButtonInput);
    });
