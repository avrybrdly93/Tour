        ...
        var map = new google.maps.Map(document.getElementById('map'), {
          ...
          for (i = 0; i < locations.length; i++) {  
            ...
            google.maps.event.addListener(marker, 'click', (function(marker, i) {
              return function() {
                infowindow.setContent('<h4>' + locations[i][0]  + '</h4><br>' + eventAddress +  '<br>' + '<a target="_blank" href="https://www.google.com/maps/search/?api=1&query=' +  eventAddress + '">View on Google Maps</a>');
